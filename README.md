...
| [EDA Звонки операторов клиентам](https://datalens.yandex/t9lanrp32y7ef](https://github.com/venera-key/EDA_sales_call_center)) | Разведочный анализ данных в контакт центре - телемаркетинг. Основные выводы. Формулирование гипотез и выбор самой продуктивной | pandas, seaborn, matplotlib |<br><br>
